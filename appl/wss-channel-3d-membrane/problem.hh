...
private:
    ...
    { return gridData_->getBoundaryDomainMarker(scvf.boundaryFlag()) == 6; }

    bool isOutlet_(const SubControlVolumeFace& scvf) const
    {
        return (
            gridData_->getBoundaryDomainMarker(scvf.boundaryFlag()) == 7
            || gridData_->getBoundaryDomainMarker(scvf.boundaryFlag()) == 8
            || gridData_->getBoundaryDomainMarker(scvf.boundaryFlag()) == 9
        );
    }
